                            ...
                            <div className="col-xl-4 col-lg-4 mb-50 leftside">
                                ...
                                <div className="footer-social-icon">
                                    ...
                                    <a className="nothing" href="https://www.facebook.com/BichoStoreAAAJ?locale=es_LA">
                                        <i className="fab">
                                            <svg class="facebook__icon--svg" viewBox="0 0 20 20">
                                    ...
                                    <a className="nothing" href="https://www.instagram.com/bichostoreaaaj/"><i className="fab">
                                        <svg class="instagram__icon--svg" viewBox="0 0 20 20">
                                    ...
                                    <a className="nothing" href="https://twitter.com/AAAJoficial">
                                        <i className="fab">
                                            <svg class="twitter__icon--svg" viewBox="0 0 20 20">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6 mb-50">
                                <div className="footer-widget">
                                    ...
                                    <div className="footer-text mb-25">
                                        <ul class="d3-o-payments__img-container">
