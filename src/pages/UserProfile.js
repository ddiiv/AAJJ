                ...
                <>
                    <section className="profile-actions">
                        <div className="profile-card__buttons">
                            <article className="profile-action accountPrincipal">
                                <div className="hub-header__icon">
                                    <svg className="profile-img-action" viewBox="0 0 24 24">
                                ...
                                <div className="detail-card__action">
                                    <div className="detail-card_header">
                                        <h3 className="detail-card__title account">{context?.User}</h3>
                                    </div>
                                    <div className="detail-card-description">
                                        <span className="rich-text"><p className="detail-card__text">{context?.Email}</p></span>

                                    </div>
                                </div>

                            </article>
                            <Link className="nothing--profile" to="/profile/personal_data">
                                <article className="profile-action">
                                    ...
                                    <div className="profileCard__button">
                                        <button className="redirect_action--profilebutton">
                                            <svg className="profile-img-action" viewBox="0 0 20 20">
                            ...
                            <Link className="nothing--profile" to="/profile/account_settings">
                                <article className="profile-action">
                            ...
                            <Link className="nothing--profile" to={`/profile/orders_${localStorage.getItem("token")}`}>
                                <article className="profile-action">
                                    <div className="hub-header__icon">
                                        <svg className="profile-img-action" viewBox="0 0 20 20">
                            ...
                            <Link className="nothing--profile" to="/profile/pay_methods">
                                <article className="profile-action">
                                    <div className="hub-header__icon">
                                        <svg className="profile-img-action" viewBox="0 0 20 20">
